...
Story itemMoviePopularStory = Story(
    name: 'Item Movie Popular',
    description: '''
`ItemMovie` muestra una tarjeta de película popular interactiva.
Incluye imagen de fondo, detalles como titulo, generos y popularidad.
''',
    builder: (context) {
      return Center(
        child: Padding(

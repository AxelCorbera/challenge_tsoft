...
/// [PopularMovies] es un sub-panel de [HomeRightPanel] que muestra las peliculas
/// mas populares.
///
/// Muestra el titulo de la clase, posee un botón para
/// ver todas las pelicuas y muestra 3 [ItemMovies]
///
...
///
/// Se muestran los 3 primeros elementos del listado
///
/// Mientras espera los resultados muestra 3 [Shimmer] con las mismas
        ...
        children: [
          ...
          Padding(
            ...
            child: GenericFutureBuilder(
                ...
                future: ServiceManager().apiTmdb.moviesApi.getMoviesPopular(),
                builder: (context, data) => Row(
                      children: [
                        ...
                        Expanded(
                          child: ItemMovie(
                              movie: data.results![data.results!.length - 3],
                              height: MediaQuery.of(context).size.height * 0.19,
                              isPopular: true),
                        ),
                      ],
